const CACHE_NAME = 'unna-app-cache-v27';
const urlsToCache = ['./', './index.html', './style.css', './app.js', './manifest.json', './gastronomie.json', './vereine.json', './uebernachtungen.json', './mobilitaet.json', './icon-192.png', './icon-512.png'];
